...
public class Profil extends javax.swing.JPanel {
    ...
    /**
     * load the user into the tabs and reset the components
    ...
    public void init(user user){
        ...
        txtInsurancename.setText(user.getInsurancename());
        
        if("public".equals(user.getInsurancetype())){
        ...
        txtHealthInformation.setText(user.getHealthinformation());
                        ...
                        .addGroup(userPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(userPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(userPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtDateOfBirth, javax.swing.GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE))))
                        .addContainerGap())))
        );
    ...
    /**
     * Enable txtInsurancename when the a public insurance is selected
     * @param evt 
     */
    ...
    /**
     * Disable txtInsurancename when private is selected
     * @param evt 
     */
